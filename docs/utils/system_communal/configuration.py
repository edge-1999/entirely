...
ZDY_APP_LIST = [
    # 跨域请求
    "corsheaders", "django.contrib.staticfiles", "rest_framework",

    # 起源域
    "standard_encoding",  # 标准编码
    "account_management",  # 用户管理
    "menu_management",  # 菜单管理
    "routing_management",  # 应用路由
    "daily_records",  # 日常记录
    "password_records",  # 密码记录
    "work_records",  # 工作记录
    "data_records",  # 数据记录
    "develop_information",  # 开发信息
...
ZDY_MIDDLEWARES = [
    ...
    'docs.utils.middlewares_communal.middlewares.SubscriberRoleMenuMiddleware',
