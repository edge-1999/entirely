...
from docs.utils.admin_communal.admin_filter_obj import ProvenanceSystemSettingsMenuManagementMenuParameterAdminType
...
class ProvenanceSystemSettingsMenuManagementMenuParameterAdmin(admin.ModelAdmin):
    ...
    resource_class = AdminProxyResource
    actions = ('custom_btn',)
    list_display = ('ID_MENU', 'ICON', 'NODE_TYPE', 'NAME_SPACE',)
    list_filter = ('ID_MENU', ProvenanceSystemSettingsMenuManagementMenuParameterAdminType, "NAME_SPACE",)
    search_fields = ('ICON',)
    list_per_page = 10
